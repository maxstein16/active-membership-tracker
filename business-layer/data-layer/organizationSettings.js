 ...
 */
const getMembershipRequirements = async (orgId, res) => {
    try {
 ...
 */
const updateMembershipRequirements = async (orgId, updates, res) => {
    try {
 ...
 */
const deleteMembershipRequirement = async (orgId, id, res) => {
    try {
        if (!id) {
 ...
 */
const updateEmailSettings = async (orgId, updates, res) => {
    try {
